...
contract FreshDeploy is Script {
    function run() external {
        ...
        // Step 2: Deploy PropertyNFT (costs initialized in constructor)
        ...
        // Step 7: Set YieldDistributor as minter
        ...
        // Step 8: Set QuestSystem as minter
        ...
        // Step 10: Verify PropertyNFT costs
        console.log("\n10. Verifying PropertyNFT costs...");
        uint256 residentialCost = propertyNFT.propertyCosts(0);
        uint256 commercialCost = propertyNFT.propertyCosts(1);
        uint256 industrialCost = propertyNFT.propertyCosts(2);
        console.log("   Residential:", residentialCost / 10**18, "TYCOON");
        console.log("   Commercial:", commercialCost / 10**18, "TYCOON");
        console.log("   Industrial:", industrialCost / 10**18, "TYCOON");
        ...
        // Step 11: Verify QuestSystem configuration
        ...
        console.log("    QuestSystem PropertyNFT:", questPropertyNFT);
        
        // Step 12: Fund TokenSwap
        console.log("\n12. Funding TokenSwap...");
        uint256 swapFundAmount = 1_000_000 * 10**18;
...
contract FreshDeploy is Script {
    function run() external {
        ...
        console.log("\n10. Verifying PropertyNFT costs...");
        uint256 residentialCost = propertyNFT.propertyCosts(0); // Residential
        uint256 commercialCost = propertyNFT.propertyCosts(1); // Commercial
        uint256 industrialCost = propertyNFT.propertyCosts(2); // Industrial
