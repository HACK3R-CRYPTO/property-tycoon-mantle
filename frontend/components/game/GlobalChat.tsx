...
import { X, Send, MessageSquare, User, Sparkles, Globe, Loader2 } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { Input } from '@/components/ui/input';
import { ScrollArea } from '@/components/ui/scroll-area';
import { Avatar, AvatarFallback, AvatarImage } from '@/components/ui/avatar';
import { useSomniaChat } from '@/hooks/useSomniaChat';
...
export function GlobalChat({ isOpen, onClose }: GlobalChatProps) {
  ...
  const { messages, isLoading, isSending, sendMessage } = useSomniaChat(user?.username);
            ...
            <div className="p-4 border-b border-white/10 flex items-center justify-between bg-white/5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-emerald-400/80">Live on Somnia Network</p>
                </div>
              </div>
              <Button
                variant="ghost"
